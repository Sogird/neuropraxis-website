      ...
      <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true">
            <rect x="0" y="0" width="10" height="10" rx="2" className="fill-brand" />
            <rect x="13" y="0" width="10" height="10" rx="2" className="fill-brand-dark" />
            <rect x="6.5" y="13" width="10" height="10" rx="2" className="fill-brand-dark" />
          </svg>
